#include <PhoenixLib/Utility.h>
//#include <sysSymTbl.h>

double PhoenixLib::AnalogInScale(double oldx, double center)
{
...
void PhoenixLib::PrintToLCD(char* format, ...)
{
...
double PhoenixLib::LimitMix(double value, double maxValue)
{
...
double PhoenixLib::LimitMix(double value)
{
	double limited_value = 0;
...
//double PhoenixLib::UnitsPerSecond(double value)
//{
