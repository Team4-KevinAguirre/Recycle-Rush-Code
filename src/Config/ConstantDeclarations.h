...
DECLARE_DOUBLE(SOLENOID_LEFT_ARM_REV, 0);
DECLARE_DOUBLE(SOLENOID_RIGHT_ARM_FWD, 3);
DECLARE_DOUBLE(SOLENOID_RIGHT_ARM_REV, 2);


// Digital Sensors
DECLARE_DOUBLE(ENCODER_LEFT_DRIVE_A, 0);
DECLARE_DOUBLE(ENCODER_LEFT_DRIVE_B, 1);
DECLARE_DOUBLE(ENCODER_RIGHT_DRIVE_A, 2);
DECLARE_DOUBLE(ENCODER_RIGHT_DRIVE_B, 3);

//Analog Sensors
DECLARE_DOUBLE(GYRO_DRIVE, 0);

//PID Constants
DECLARE_DOUBLE(PID_DRIVE_SPEED_KP,0.12)
DECLARE_DOUBLE(PID_DRIVE_SPEED_KI,0.0)
DECLARE_DOUBLE(PID_DRIVE_SPEED_KD,0)
...
DECLARE_DOUBLE(DRIVE_MAX_SPEED, 10)

DECLARE_DOUBLE(turnNonlinHigh, 0.9)
DECLARE_DOUBLE(negInertia, 5.0)
DECLARE_DOUBLE(sensitivity, 1.10)
